    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl flex flex-col h-[90vh] sm:h-auto sm:max-h-[90vh] overflow-hidden">
        ...
        <div className="flex justify-between items-center p-3 sm:p-4 border-b shrink-0">
          <h3 className="font-bold text-base sm:text-lg">ปรับแต่งรูปภาพ (Crop Image)</h3>
        ...
        {/* Cropper Area */}
        <div className="relative flex-1 bg-black min-h-[30vh]">
          <Cropper
            image={imageSrc}
            crop={crop}
            zoom={zoom}
        ...
        {/* Controls */}
        <div className="p-3 sm:p-4 bg-gray-50 flex flex-col gap-3 sm:gap-4 overflow-y-auto shrink-0 max-h-[50vh]">
              ...
              <div className="flex flex-wrap gap-1 sm:gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`px-2 py-1 sm:px-3 text-[10px] sm:text-xs rounded-md border ${
