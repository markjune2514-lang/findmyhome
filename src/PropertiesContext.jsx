...
export const PropertiesProvider = ({ children }) => {
  const { user } = useAuth() || {};
  const cacheKey = user ? 'fmh_properties_admin_v29_cache' : 'fmh_properties_public_v29_cache';
  const cacheTimeKey = user ? 'fmh_properties_admin_v29_time' : 'fmh_properties_public_v29_time';
  ...
  const clearSessionCaches = () => {
    try {
      ...
      sessionStorage.removeItem('fmh_properties_admin_v27_cache');
      sessionStorage.removeItem('fmh_properties_admin_v27_time');
      sessionStorage.removeItem('fmh_properties_public_v27_cache');
      sessionStorage.removeItem('fmh_properties_public_v27_time');
      sessionStorage.removeItem('fmh_properties_admin_v28_cache');
      sessionStorage.removeItem('fmh_properties_admin_v28_time');
      sessionStorage.removeItem('fmh_properties_public_v28_cache');
      sessionStorage.removeItem('fmh_properties_public_v28_time');
    } catch (e) {
  ...
  const [properties, setProperties] = useState(() => {
    try {
      const activeCacheKey = user ? 'fmh_properties_admin_v29_cache' : 'fmh_properties_public_v29_cache';
      const activeTimeKey = user ? 'fmh_properties_admin_v29_time' : 'fmh_properties_public_v29_time';
